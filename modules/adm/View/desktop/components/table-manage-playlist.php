<div class="table-container bg-color-white rounded-6 box-shadow-01">
    <div class="table-top">
        ...
        <?php include_one('adm.components.actions-manage-playlist') ?>
    </div>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <?php
                        foreach (config('adm.playlist.table.columns') as $column) {
                        ...
                        foreach ($playlists as $key => $playlist) {
                            ...
                            ?>
                                <tr id="row-<?php echo $key ?>">
                                    <td>
                                        <div class="form-check form-check-01">
                                            <input id="checkbox-<?php echo $key ?>" name="playlist_ids[]" value="<?php echo $playlist['id'] ?>" class="form-check-input cursor-pointer" type="checkbox">
                                    ...
                                    <td>
                                        <div class="d-flex position-relative">
                                            ...
                                            <?php _require('adm.components.options-manage-playlist', compact('key', 'playlist')) ?>
                                        </div>
                                    </td>
                                </tr>
                            <?php
