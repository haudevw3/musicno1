<div class="table-container bg-color-white rounded-6 box-shadow-01">
    <div class="table-top">
        ...
        <?php include_one('adm.components.actions-manage-song') ?>
    </div>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <?php
                        foreach (config('adm.song.table.columns') as $column) {
                        ...
                        foreach ($songs as $key => $song) {
                            ...
                            ?>
                                <tr id="row-<?php echo $key ?>">
                                    <td>
                                        <div class="form-check form-check-01">
                                            <input id="checkbox-<?php echo $key ?>" name="song_ids[]" value="<?php echo $song['id'] ?>" class="form-check-input cursor-pointer" type="checkbox">
                                    ...
                                    <td>
                                        <div class="d-flex position-relative">
                                            ...
                                            <?php _require('adm.components.options-manage-song', compact('key', 'song')) ?>
                                        </div>
                                    </td>
                                </tr>
                            <?php
