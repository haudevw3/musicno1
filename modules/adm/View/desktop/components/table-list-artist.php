                                ...
                                <tr id="row-<?php echo $key ?>">
                                    ...
                                    <td>
                                        <div class="d-flex position-relative">
                                            ...
                                            <a href="<?php echo route('adm-edit-artist', $id) ?>" class="table-btn center-items ml-10"><i class="fa-regular fa-pen-to-square"></i></a>
                                            <div data-url="<?php echo route('adm-delete-artist', $id) ?>" class="table-btn center-items ml-10 show-modal"><i class="fa-regular fa-trash-can"></i></div>
                                            <?php _require('adm.components.dropdown-manager-artist', compact('key', 'id')) ?>
                                        </div>
                                    </td>
                                </tr>
                            <?php
