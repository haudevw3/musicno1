<div class="table-container bg-color-white rounded-6 box-shadow-01">
    <div class="table-top">
        ...
        <?php include_one('adm.components.actions-manage-artist') ?>
    </div>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <?php
                        foreach (config('adm.artist.table.columns') as $column) {
                        ...
                        foreach ($artists as $key => $artist) {
                            ...
                            ?>
                                <tr id="row-<?php echo $key ?>">
                                    <td>
                                        <div class="form-check form-check-01">
                                            <input id="checkbox-<?php echo $key ?>" name="artist_ids[]" value="<?php echo $artist['id'] ?>" class="form-check-input cursor-pointer" type="checkbox">
                                    ...
                                    <td>
                                        <div class="d-flex position-relative">
                                            ...
                                            <div data-url="<?php echo route('adm-delete-artist', $artist['id']) ?>" class="table-btn center-items ml-10 show-modal"><i class="fa-regular fa-trash-can"></i></div>
                                            <?php _require('adm.components.options-manage-artist', compact('key', 'artist')) ?>
                                        </div>
                                    </td>
                                </tr>
                            <?php
