<div id="table-song" class="table-container bg-color-white rounded-6 box-shadow-01">
    <div class="table-top">
                        ...
                        foreach ($songs as $key => $song) {
                            ...
                            ?>
                                <tr id="row-<?php echo $key ?>">
                                    <td>
                                        <div class="form-check form-check-01">
                                            <input id="check-box-<?php echo $key ?>" name="ids[]" value="<?php echo $song['id'] ?>" class="form-check-input cursor-pointer" type="checkbox">
                                    ...
                                    <td>
                                        <div class="d-flex position-relative">
                                            <div row-id="<?php echo $key ?>" class="table-btn center-items choose-detail-song"><i class="fa-regular fa-ellipsis-vertical fw-600"></i></div>
                                            <a href="<?php echo route('adm-edit-song', $song['id']) ?>" class="table-btn center-items ml-10"><i class="fa-regular fa-pen-to-square"></i></a>
                                            <div data-url="<?php echo route('adm-delete-song', $song['id']) ?>" class="table-btn center-items ml-10 choose-delete-song"><i class="fa-regular fa-trash-can"></i></div>
