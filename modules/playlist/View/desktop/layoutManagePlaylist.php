        ...
        <div class="col-3 items-align-vertical-center">
            <div class="page-header-title d-flex">
                <div class="page-header-icon">
                    <i class="fa-regular fa-list-music text-gray"></i>
                </div>
                <span class="fw-semibold ml-10">Danh sách phát</span>
            </div>
        </div>
        <?php _require('playlist.components.actions-manage-playlist') ?>
    </div>
</header>

<main id="page-main-content" class="page-main-content">
    <?php _require('components.adm.modal-dialog') ?>
    <?php require _namespace('playlist.components.table-manage-playlist') ?>
</main>