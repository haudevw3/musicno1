<div class="music-left vertical-center-items">
    <div class="song-info vertical-center-items">
        <div id="song-image" class="song-image">
            <img class="rounded-6" src="">
        </div>
        <div class="song-text ml-10">
            <div id="song-name" class="fw-500 text-color-white text-overflow-01"></div>
            <div id="artist-name" class="fs-12 fw-500 text-overflow-01"></div>
        </div>
    </div>
    <div class="song-interact vertical-center-items">
...
<div class="music-center vertical-center-items">
    <div class="music-wrapper">
        ...
        <div class="music-progress center-items">
            ...
            <div id="duration-music" class="fw-500 text-color-white">00:00</div>
        </div>
    </div>
</div>
